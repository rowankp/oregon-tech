//**********************************************************
// filename: cVisitor.h
// purpose: definition of Visitor base class
// author: Rowan Parker (rowan.parker@oit.edu)
// date: 02/03/2020

// NOTE: need forward declaration of all classes. Forward 
//       declare them to avoid circular include problems.
...
class cVisitor
{
    public:
        ...
        //**************************************************
        // visitor implementations must define the visit 
        // order. This will usually just be a call to 
        // VisitAllChildren()
